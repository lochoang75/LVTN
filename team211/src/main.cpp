...
void imageCallback(const sensor_msgs::ImageConstPtr& msg)
{
    ...
    try
    {
        ...
        Mat imgThresholded = detectLane(cv_ptr->image);
    }
...
int main(int argc, char** argv)
{
	...
	//Mat img = imread("C:/Users/15122/Documents/Visual Studio 2015/Projects/Default/Default/image/101c86.jpg");
